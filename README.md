...
|-----|---------|-------------|
| [BottomAeration_Hold](./BottomAeration_Hold/) | 4.59 | Pneumatic bottom + gutter aeration control per cargo hold — smart, pressure-based valve selection |
...
|-----|---------|-------------|---------|
| [BitCheck](./_Helpers/BitCheck/) | 0.11 | Splits a WORD into 16 BOOLs + counts active bits | DValve, CommunicationAerzen, BottomAeration_Hold |
...
| [RotateValve](./_Helpers/RotateValve/) | 0.07 | Packs rotation angle (0–360°) into DValve HMI status word | DValve, BottomAeration_Hold |
